 ...
 * net.rainbowcreation.vocanicz.minegit.core.model.BlockState}.
 *
...
public final class BlockStateBridge {
     ...
     */
    public static net.rainbowcreation.vocanicz.minegit.core.model.BlockState toCore(
        ...
        return new net.rainbowcreation.vocanicz.minegit.core.model.BlockState(id, props);
    }
    ...
    private static String render(net.rainbowcreation.vocanicz.minegit.core.model.BlockState core) {
