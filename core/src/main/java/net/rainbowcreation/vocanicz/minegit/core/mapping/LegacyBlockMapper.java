package net.rainbowcreation.vocanicz.minegit.core.mapping;
...
public final class LegacyBlockMapper {
    ...
    private static final String DEFAULT_RESOURCE = "/net/rainbowcreation/vocanicz/minegit/core/mapping/legacy-blocks.tsv";
